...
from cross_view_transformer.utils.geometry import mat2pose_vec, pose_vec2mat, warp_features
...
def predict_instance_segmentation_and_trajectories(
        output, compute_matched_centers=False, make_consistent=True, vehicles_id=1, if_return_centers=False,
):
    preds = output['segmentation'].detach()

    # print('=============ins pred==============, preds max:', preds.max())
    # print('=============ins pred==============, preds min:', preds.min())
    ...
    # print('foreground_masks sum:', foreground_masks.sum())
    ...
    if if_return_centers:
        return consistent_instance_seg, centers
    else:
        return consistent_instance_seg
